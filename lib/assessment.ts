/** Raw score sum of all questions at max (used to normalize to 0–100) — `/assessment` flow. */
export const ASSESSMENT_MAX_RAW = 140

/** Raw score max for the partnerships questionnaire (`/partnerships`). */
export const PARTNERSHIP_MAX_RAW = 150
...
/** Practice assessment (`/assessment`) — original questionnaire. */
...
/** Partnerships intake (`/partnerships`) — immigration / capacity–focused q6, q9, q10. */
export const PARTNERSHIP_QUESTIONS: AssessmentQuestion[] = [
  {
    id: 'q1',
    label: 'How long have you been running your practice?',
    type: 'single',
